    ...
    <div className='payout-container'>
      ...
      {open && (
        <div id='open-modal' class='modal-window'>
          <div>
            <a onClick={handleClose} title='Close' class='modal-close'>
              Close
            </a>
            <h1>Voilà!</h1>
            <div>
              A CSS-only modal based on the :target pseudo-class. Hope you find
              it helpful.
            </div>
            <br />
            <div>
            ...
            {/* <img
            src='https://periphery.app/assets/wordmark-7b7617b2.svg'
            style='width: 120px'
          /> */}
